...
Customize your Nextfolio setup by updating your information to ensure proper SEO, Open Graph integration, and other settings.

### Config.ts

Update the site metadata and social links in the **app/config.ts** file. These constants are utilized across the site for SEO, social links, and Open Graph integration.
...
Your portfolio is equipped with SEO and analytics. Nextfolio is fully customizable, allowing you to add features as needed.
